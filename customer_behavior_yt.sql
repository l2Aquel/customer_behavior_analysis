...
--Q4. Compare the average Purchase Amounts Awith Standard and Express Shipping.
...
select subscription_status,count(subscription_status) as total_customers,round(avg(purchase_amount),2) as avg_spend,sum(purchase_amount) as total_revenue
from customer
group by subscription_status
order by total_revenue, total_revenue desc;
